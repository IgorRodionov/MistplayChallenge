...
class GameRowAdapter(private val gameList: List<GameEntity>,
                     private val listener: (GameEntity) -> Unit) : RecyclerView.Adapter<GameViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        GameViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.game_item, parent, false), listener)
